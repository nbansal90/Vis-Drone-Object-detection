...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      args.set_cfgs = ['FPN_ANCHOR_SCALES', '[32, 64, 128, 256, 512]', 'FPN_FEAT_STRIDES', '[4, 8, 16, 32, 64]', 'MAX_NUM_GT_BOXES', '80']
  ...
  output_dir = args.save_dir[0] + "/" + "fpn_aug_new" + "/" + args.dataset
  ...
  dataset = roibatchLoader(roidb, ratio_list, ratio_index, args.batch_size, \
                           imdb.num_classes, -1, training=True)
